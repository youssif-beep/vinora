...
const TEMPLATES_A: Record<string, string> = {
  'Persönliche Einladung': 'Liebe/r [Vorname],\n\nals einer unserer geschätztesten Kunden möchten wir Sie herzlich zu unserer exklusiven Jahrgangspräsentation einladen. Als Erster erhalten Sie die Möglichkeit, unsere neuesten [Lieblingssorte]-Abfüllungen zu verkosten.\n\nIch würde mich freuen, Sie persönlich begrüßen zu dürfen.\n\nMit herzlichen Grüßen',
